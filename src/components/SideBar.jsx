    ...
    return (
        <div className="w-[13%] border-r-1 border-gray-300 min-h-screen flex flex-col items-center p-5 shadow-lg shadow-gray-600/50">
            ...
            <div className="flex flex-col gap-2 text-gray-500 mb-10">
                <h5 className="mb-4 hover:font-semibold hover:text-lg" onClick={(() => {})}>Dashboard</h5>
                <h5 className="mb-4 hover:font-semibold hover:text-lg" onClick={() => console.log("Clicked on Tickets")}>Tickets</h5>
                <h5 className="mb-4 hover:font-semibold hover:text-lg" onClick={() => {}}>Administration</h5>
            </div>
