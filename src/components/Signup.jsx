...
const Signup = () => {
  return (
    <>
      <h1 className="text-gray-500 text-3xl w-[5%] mx-auto mt-[20px] text-blue-500 font-semibold">Signup</h1>
      <div
      className="bg-white w-4/12 mx-auto mt-[90px] border-2 border-gray-100 shadow-lg shadow-gray-350/50
